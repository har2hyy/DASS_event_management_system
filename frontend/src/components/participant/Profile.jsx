...
const ParticipantProfile = () => {
 ...
 {/* Tabs */}
 <div className="flex gap-1 mb-6 bg-white/5 rounded-lg md: p-1 w-fit">
 ...
 onChange={(e) => { if (/^[0-9]*$/.test(e.target.value)) setForm({ ...form, contactNumber: e.target.value }); }}
 ...
 className="w-full bg-white/5 border border-gray-600 px-3 py-2.5 text-sm text-white focus:outline-none focus:ring-2 focus:ring-indigo-500" />
 </div>
 ))}
 {pwMsg && (
